...
/**
 * Aggregate Root representing a processed abbreviated tax invoice.
 *
 * Abbreviated tax invoices differ from full tax invoices: they only have a seller party
 * (no buyer party), as per the Thai e-Tax abbreviated invoice specification.
 */
public class ProcessedAbbreviatedTaxInvoice {

    // Identity
    private final AbbreviatedTaxInvoiceId id;
    ...
    // Parties (abbreviated tax invoice has seller only, no buyer)
    ...
    private ProcessedAbbreviatedTaxInvoice(Builder builder) {
        this.id = Objects.requireNonNull(builder.id, "Abbreviated Tax Invoice ID is required");
    ...
    private void validateInvariant() {
        if (items.isEmpty()) {
            throw new IllegalStateException("Abbreviated tax invoice must have at least one line item");
        }
    ...
    // Getters
    public AbbreviatedTaxInvoiceId getId() {
        return id;
    }
    ...
    /**
     * Builder for ProcessedAbbreviatedTaxInvoice
     */
    public static class Builder {
        private AbbreviatedTaxInvoiceId id;
        ...
        public Builder id(AbbreviatedTaxInvoiceId id) {
            this.id = id;
            return this;
        }
        ...
        public ProcessedAbbreviatedTaxInvoice build() {
            return new ProcessedAbbreviatedTaxInvoice(this);
        }
    }
