...
@Getter
public class CompensateAbbreviatedTaxInvoiceCommand extends SagaCommand {
    ...
    public CompensateAbbreviatedTaxInvoiceCommand(String sagaId, SagaStep sagaStep, String correlationId,
