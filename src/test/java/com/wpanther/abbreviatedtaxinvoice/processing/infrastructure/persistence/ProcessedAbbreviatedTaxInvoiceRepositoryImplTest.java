...
/**
 * Integration tests for ProcessedAbbreviatedTaxInvoiceRepositoryImpl
 */
@DataJpaTest
@Import({ProcessedAbbreviatedTaxInvoiceRepositoryImpl.class, ProcessedAbbreviatedTaxInvoiceMapper.class})
@ActiveProfiles("test")
class ProcessedAbbreviatedTaxInvoiceRepositoryImplTest {

    @Autowired
    private ProcessedAbbreviatedTaxInvoiceRepository repository;

    private ProcessedAbbreviatedTaxInvoice testInvoice;
    ...
    void setUp() {
        ...
        testInvoice = ProcessedAbbreviatedTaxInvoice.builder()
            .id(AbbreviatedTaxInvoiceId.generate())
            .sourceInvoiceId("intake-test-123")
            .invoiceNumber("ABR-TEST-001")
    ...
    void testSaveAndFindById() {
        // When
        ProcessedAbbreviatedTaxInvoice saved = repository.save(testInvoice);
        Optional<ProcessedAbbreviatedTaxInvoice> found = repository.findById(saved.getId());
    ...
    void testFindByIdNotFound() {
        // Given
        AbbreviatedTaxInvoiceId nonExistentId = AbbreviatedTaxInvoiceId.generate();

        // When
        Optional<ProcessedAbbreviatedTaxInvoice> found = repository.findById(nonExistentId);
    ...
    void testFindBySourceInvoiceId() {
        ...
        // When
        Optional<ProcessedAbbreviatedTaxInvoice> found = repository.findBySourceInvoiceId("intake-test-123");

        // Then
        assertTrue(found.isPresent());
        assertEquals("intake-test-123", found.get().getSourceInvoiceId());
        assertEquals("ABR-TEST-001", found.get().getInvoiceNumber());
    }

    @Test
    void testFindBySourceInvoiceIdNotFound() {
        // When
        Optional<ProcessedAbbreviatedTaxInvoice> found = repository.findBySourceInvoiceId("non-existent");
    ...
    void testFindByStatus() {
        ...
        // When
        List<ProcessedAbbreviatedTaxInvoice> found = repository.findByStatus(ProcessingStatus.PENDING);
    ...
    void testFindByStatusEmpty() {
        // When
        List<ProcessedAbbreviatedTaxInvoice> found = repository.findByStatus(ProcessingStatus.COMPLETED);
    ...
    void testSavePreservesAllFields() {
        ...
        // Then
        assertTrue(found.isPresent());
        ProcessedAbbreviatedTaxInvoice invoice = found.get();
        ...
        // Check seller (abbreviated invoice has no buyer)
    ...
    void testUpdateInvoice() {
        ...
        // When
        ProcessedAbbreviatedTaxInvoice updated = repository.save(saved);
        Optional<ProcessedAbbreviatedTaxInvoice> found = repository.findById(updated.getId());
    ...
    void testSaveMultipleInvoices() {
        // Given
        ProcessedAbbreviatedTaxInvoice invoice2 = ProcessedAbbreviatedTaxInvoice.builder()
            .id(AbbreviatedTaxInvoiceId.generate())
            .sourceInvoiceId("intake-test-456")
            .invoiceNumber("ABR-TEST-002")
        ...
        // Then
        Optional<ProcessedAbbreviatedTaxInvoice> found1 = repository.findBySourceInvoiceId("intake-test-123");
        Optional<ProcessedAbbreviatedTaxInvoice> found2 = repository.findBySourceInvoiceId("intake-test-456");
    ...
    void testCompleteWorkflowWithRepository() {
        ...
        ProcessedAbbreviatedTaxInvoice finalInvoice = repository.save(saved);

        // Then
        Optional<ProcessedAbbreviatedTaxInvoice> found = repository.findById(finalInvoice.getId());
        assertTrue(found.isPresent());
