...
class OutboxEventEntityTest {
    ...
    class BuilderTests {
        ...
        void testBuilderWithAllFields() {
            ...
            OutboxEventEntity entity = OutboxEventEntity.builder()
                ...
                .retryCount(0)
                .errorMessage(null)
                .topic("abbreviated.taxinvoice.processed")
                .partitionKey("abr-inv-123")
            ...
            assertEquals("ProcessedAbbreviatedTaxInvoice", entity.getAggregateType());
            assertEquals("abr-inv-123", entity.getAggregateId());
            assertEquals("AbbreviatedTaxInvoiceProcessedEvent", entity.getEventType());
            ...
            assertEquals("abbreviated.taxinvoice.processed", entity.getTopic());
            assertEquals("abr-inv-123", entity.getPartitionKey());
        ...
        void testBuilderWithMinimalFields() {
            ...
            OutboxEventEntity entity = OutboxEventEntity.builder()
                .aggregateType("ProcessedAbbreviatedTaxInvoice")
                .aggregateId("abr-inv-456")
                .eventType("AbbreviatedTaxInvoiceReplyEvent")
                .payload("{}")
                .build();
            ...
            assertNotNull(entity);
            assertEquals("ProcessedAbbreviatedTaxInvoice", entity.getAggregateType());
            assertEquals("abr-inv-456", entity.getAggregateId());
            assertEquals("AbbreviatedTaxInvoiceReplyEvent", entity.getEventType());
    ...
    class PrePersistTests {
        ...
        void testPrePersistDefaults() {
            ...
            entity.setAggregateType("ProcessedAbbreviatedTaxInvoice");
            entity.setAggregateId("abr-inv-789");
            entity.setEventType("AbbreviatedTaxInvoiceProcessedEvent");
        ...
        void testPrePersistDoesNotOverride() {
            ...
            entity.setAggregateType("ProcessedAbbreviatedTaxInvoice");
            entity.setAggregateId("abr-inv-999");
            entity.setEventType("AbbreviatedTaxInvoiceProcessedEvent");
            entity.setPayload("{\"test\":true}");
    ...
    class DomainConversionTests {
        ...
        void testFromDomain() {
            ...
            OutboxEvent domainEvent = OutboxEvent.builder()
                .id(id)
                .aggregateType("ProcessedAbbreviatedTaxInvoice")
                .aggregateId("abr-inv-from-domain")
                .eventType("AbbreviatedTaxInvoiceProcessedEvent")
                ...
                .errorMessage(null)
                .topic("abbreviated.taxinvoice.processed")
                .partitionKey("abr-inv-from-domain")
            ...
            assertEquals(id, entity.getId());
            assertEquals("ProcessedAbbreviatedTaxInvoice", entity.getAggregateType());
            assertEquals("abr-inv-from-domain", entity.getAggregateId());
            assertEquals("AbbreviatedTaxInvoiceProcessedEvent", entity.getEventType());
            ...
            assertNull(entity.getErrorMessage());
            assertEquals("abbreviated.taxinvoice.processed", entity.getTopic());
            assertEquals("abr-inv-from-domain", entity.getPartitionKey());
        ...
        void testToDomain() {
            ...
            OutboxEventEntity entity = OutboxEventEntity.builder()
                ...
                .topic("saga.reply.abbreviated-tax-invoice")
                .partitionKey("abr-inv-to-domain")
                .headers("{\"key\":\"value\"}")
                .build();
            ...
            assertEquals("ProcessedAbbreviatedTaxInvoice", domainEvent.getAggregateType());
            assertEquals("abr-inv-to-domain", domainEvent.getAggregateId());
            assertEquals("AbbreviatedTaxInvoiceReplyEvent", domainEvent.getEventType());
            assertEquals("{\"status\":\"SUCCESS\"}", domainEvent.getPayload());
            ...
            assertEquals("saga.reply.abbreviated-tax-invoice", domainEvent.getTopic());
            assertEquals("abr-inv-to-domain", domainEvent.getPartitionKey());
        ...
        void testRoundTripConversion() {
            ...
            OutboxEvent originalDomain = OutboxEvent.builder()
                ...
                .errorMessage(null)
                .topic("abbreviated.taxinvoice.processed")
                .partitionKey("abr-inv-roundtrip")
        ...
        void testFromDomainWithNullOptionalFields() {
            ...
            assertEquals(id, entity.getId());
            assertEquals("ProcessedAbbreviatedTaxInvoice", entity.getAggregateType());
            assertEquals("abr-inv-minimal", entity.getAggregateId());
            assertEquals("AbbreviatedTaxInvoiceProcessedEvent", entity.getEventType());
    ...
    class GettersSettersTests {
        ...
        void testSettersAndGetters() {
            ...
            entity.setId(id);
            entity.setAggregateType("ProcessedAbbreviatedTaxInvoice");
            entity.setAggregateId("abr-inv-setters");
            entity.setEventType("AbbreviatedTaxInvoiceProcessedEvent");
            ...
            entity.setTopic("abbreviated.taxinvoice.processed");
            entity.setPartitionKey("abr-inv-setters");
            entity.setHeaders("{\"key\":\"value\"}");

            // Assert
            assertEquals(id, entity.getId());
            assertEquals("ProcessedAbbreviatedTaxInvoice", entity.getAggregateType());
            assertEquals("abr-inv-setters", entity.getAggregateId());
            assertEquals("AbbreviatedTaxInvoiceProcessedEvent", entity.getEventType());
            ...
            assertNull(entity.getErrorMessage());
            assertEquals("abbreviated.taxinvoice.processed", entity.getTopic());
            assertEquals("abr-inv-setters", entity.getPartitionKey());
    ...
    class ConstructorTests {
        ...
        void testAllArgsConstructor() {
            ...
            OutboxEventEntity entity = new OutboxEventEntity(
                ...
                "abr-inv-allargs",
                "AbbreviatedTaxInvoiceProcessedEvent",
                "{\"allargs\":true}",
                now,
                now.plusSeconds(5),
            ...
            assertEquals(id, entity.getId());
            assertEquals("ProcessedAbbreviatedTaxInvoice", entity.getAggregateType());
            assertEquals("abr-inv-allargs", entity.getAggregateId());
            assertEquals("AbbreviatedTaxInvoiceProcessedEvent", entity.getEventType());
            ...
            assertNull(entity.getErrorMessage());
            assertEquals("abbreviated.taxinvoice.processed", entity.getTopic());
            assertEquals("abr-inv-allargs", entity.getPartitionKey());
