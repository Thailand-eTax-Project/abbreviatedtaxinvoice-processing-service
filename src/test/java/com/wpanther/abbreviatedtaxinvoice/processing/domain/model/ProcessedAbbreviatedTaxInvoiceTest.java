...
/**
 * Unit tests for ProcessedAbbreviatedTaxInvoice aggregate root
 */
class ProcessedAbbreviatedTaxInvoiceTest {

    private ProcessedAbbreviatedTaxInvoice.Builder validInvoiceBuilder;
    ...
    void setUp() {
        ...
        validInvoiceBuilder = ProcessedAbbreviatedTaxInvoice.builder()
    ...
    void testCreateValidInvoice() {
        // When
        ProcessedAbbreviatedTaxInvoice invoice = validInvoiceBuilder.build();

        // Then
        assertNotNull(invoice);
        assertEquals("intake-123", invoice.getSourceInvoiceId());
        assertEquals("ABR-001", invoice.getInvoiceNumber());
    ...
    void testCalculateTotalsWithMultipleItems() {
        ...
        ProcessedAbbreviatedTaxInvoice invoice = validInvoiceBuilder
            .addItem(item2)
            .build();
    ...
    @Test
    void testNoBuyerField() {
        // Abbreviated tax invoices have no buyer - verify seller is accessible
        ProcessedAbbreviatedTaxInvoice invoice = validInvoiceBuilder.build();

        assertNotNull(invoice.getSeller());
        assertEquals("Acme Corporation", invoice.getSeller().name());
    }
}
